#!/bin/bash
clear
echo -e "\e[4;31m Atabey27 Productions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m TBomb \e[0m"
echo "Press Enter To Continue"
read a1
if [[ -s update.Atabey27 ]];then
...
echo This Script Was Made By Atabey27 >update.Atabey27
...
toilet -f mono12 -F border Atabey27
echo -e "\e[4;34m This Bomber Was Created By Atabey27 \e[0m"
echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
echo -e "\e[1;32m           Mail: ggAtabey2729@gmail.com \e[0m"
echo -e "\e[1;32m       Whatsapp: https://bit.do/Atabey27git \e[0m"
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By Atabey27'> call.xxx
...
git clone https://github.com/TheAtabey27/TBomb
if [[ -s TBomb/TBomb.sh ]];then
cd TBomb
cp -r -f * .. > temp
cd ..
rm -rf  TBomb >> temp
rm update.Atabey27 >> temp
rm temp
chmod +x TBomb.sh
fi
...
clear
echo -e "\e[1;32m"
echo 'Protect List By Atabey27'> protect.xxx
...
echo -e "\e[1;33m      [*]  Atabey27   \e[1;31m"
echo "         [-] Mail At: ggAtabey2729@gmail.com"
